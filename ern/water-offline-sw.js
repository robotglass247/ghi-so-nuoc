const CACHE='water-ern-v20-offline-fast6';
...
const LIVE_BACKEND='https://script.google.com/macros/s/AKfycbwoAdo6eDn_4sJkhnIVAwEmf5IEi15zsLSduKmpg02l7ZcRBYO27fE4HCuXUJUNp0g/exec';

// Deployment đang được khai báo trong Ma.gs mới nhất của dự án.
// Chỉ dùng làm nguồn CHÍNH để tải danh sách nhân sự động.
const STAFF_BACKEND='https://script.google.com/macros/s/AKfycbwoAdo6eDn_4sJkhnIVAwEmf5IEi15zsLSduKmpg02l7ZcRBYO27fE4HCuXUJUNp0g/exec';
...
self.addEventListener('activate',event=>{
  event.waitUntil((async()=>{
    ...
    await Promise.all(keys
      .filter(k=>k.startsWith('water-ern-v20-offline-')&&k!==CACHE)
