const CACHE='water-v879-final3-button';
...
const GUIDE=new URL('water-shot-guide-final3.js',self.location.href).href;
...
function patchPageHtml(text){
  ...
  html=html.replace(/<script[^>]+src=["']\.\/water-shot-guide(?:-final3)?\.js[^"']*["'][^>]*><\/script>\s*/g,'');
  ...
  html=html.replace('</body>',
    ...
    '<script src="./water-shot-guide-final3.js?build='+BUILD+'"></script>\n'+
    '</body>');
  return html;
}
...
async function installCore(){
  ...
  if(!patched.includes('progressBar')||!patched.includes('water-final-core-pre.js')||!patched.includes('water-ui3.js')||!patched.includes('water-final-core-post.js')||!patched.includes('water-shot-guide-final3.js')){
    throw new Error('Trang FINAL3 chưa tạo đúng');
  }
