/* DEV ONLY - XEM CHI SO theo dung thang dang chon, cung nguon TAI_CHI_SO_THANG.
   Bat su kien o WINDOW capture de chan handler XEM cu truoc khi no mo Sheet co dinh. */
(function(){
  'use strict';

  const BUILD='r1135-view-month-v2';
  ...
  function jsonp(query){
    return new Promise(function(resolve,reject){
      const cb='__waterViewMonthV2_'+Date.now()+'_'+Math.random().toString(36).slice(2);
  ...
  // WINDOW capture chay truoc DOCUMENT capture cua handler cu va cua unified-v1.
