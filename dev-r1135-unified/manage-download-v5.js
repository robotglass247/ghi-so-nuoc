/* DEV ONLY - TAI FILE theo dung thang dang chon, cung nguon TAI_CHI_SO_THANG.
   V5: giu logic V4; man hinh thanh cong bo dong thong tin so dong/file. */
(function(){
  'use strict';

  const BUILD='r1135-download-v5-no-rowcount-line';
  ...
  function jsonp(query){
    return new Promise(function(resolve,reject){
      const cb='__waterDownloadV5_'+Date.now()+'_'+Math.random().toString(36).slice(2);
