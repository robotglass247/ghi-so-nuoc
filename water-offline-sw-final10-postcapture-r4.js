...
const GUIDE=new URL('water-shot-guide-final10-postcapture-r4.js',self.location.href).href;
...
const BUILD='879-final10-postcapture-r4';
...
function patchPageHtml(text){
  ...
  html=html.replace('</body>',
    ...
    '<script src="./water-shot-guide-final10-postcapture-r4.js?build='+BUILD+'"></script>\n'+
    '</body>');
  return html;
}
...
async function installCore(){
  ...
  if(!patched.includes('progressBar')||!patched.includes('water-final-core-pre.js')||!patched.includes('water-ui3.js')||!patched.includes('water-final-core-post.js')||!patched.includes('water-camera-fast-final6.js')||!patched.includes('water-shot-guide-final10-postcapture-r4.js')){
    throw new Error('Trang FINAL10 R4 chưa tạo đúng');
  }
