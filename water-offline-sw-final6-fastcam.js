const CACHE='water-v879-final6-fastcam';
...
const GUIDE=new URL('water-shot-guide-final6.js',self.location.href).href;
...
const BUILD='879-final6-fastcam';
...
function patchPageHtml(text){
  ...
  html=html.replace(/<script[^>]+src=["']\.\/water-shot-guide(?:-final3|-final4|-final6)?\.js[^"']*["'][^>]*><\/script>\s*/g,'');
  ...
  html=html.replace('</body>',
    ...
    '<script src="./water-shot-guide-final6.js?build='+BUILD+'"></script>\n'+
    '</body>');
  return html;
}
...
async function installCore(){
  ...
  if(!patched.includes('progressBar')||!patched.includes('water-final-core-pre.js')||!patched.includes('water-ui3.js')||!patched.includes('water-final-core-post.js')||!patched.includes('water-camera-fast-final6.js')||!patched.includes('water-shot-guide-final6.js')){
    throw new Error('Trang FINAL6 chưa tạo đúng');
  }
