 ...
 * V18 nap download moi: man hinh lon can giua + prefetch tang toc.
 */
(function(){
  'use strict';
  const BUILD='r1135-month-only-ui-preserve-v18';
  ...
  function load(){
    ...
    loading=true;
    const cb='__r1135MonthOnly18_'+Date.now()+'_'+Math.random().toString(36).slice(2),s=document.createElement('script');
    let done=false;
  ...
  loadFinalBehavior('./dev-r1135-unified/manage-download-v7-exact-view-values.js?v=18','WATER_MANAGE_DOWNLOAD_BUILD');
