const CACHE='water-v879-final9-adjacent-confirm';
...
const GUIDE=new URL('water-shot-guide-final9-confirm.js',self.location.href).href;
...
const BUILD='879-final9-adjacent-confirm';
...
function patchPageHtml(text){
  ...
  html=html.replace(/<script[^>]+src=["']\.\/water-shot-guide(?:-final3|-final4|-final6|-final9-confirm)?\.js[^"']*["'][^>]*><\/script>\s*/g,'');
  ...
  html=html.replace('</body>',
    ...
    '<script src="./water-shot-guide-final9-confirm.js?build='+BUILD+'"></script>\n'+
    '</body>');
  return html;
}
...
async function installCore(){
  ...
  if(!patched.includes('progressBar')||!patched.includes('water-final-core-pre.js')||!patched.includes('water-ui3.js')||!patched.includes('water-final-core-post.js')||!patched.includes('water-camera-fast-final6.js')||!patched.includes('water-shot-guide-final9-confirm.js')){
    throw new Error('Trang FINAL9 chưa tạo đúng');
  }
