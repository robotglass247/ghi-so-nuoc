...
const PROJECT=new URL('water-project-bar-r8.js',self.location.href).href;
...
function injectAddons(html){
  ...
  if(!out.includes('water-project-bar-r8.js')){
    out=out.replace(
      '</body>',
      '<script src="./water-project-bar-r8.js?build='+BUILD+'"></script>\n</body>'
    );
  }
