const CACHE='water-v879-final2-safe';
...
function patchPageHtml(text){
  ...
  // Gỡ đăng ký Service Worker cũ trong trang; không đụng camera/capture/DB/sync.
  ...
  // Trình tự bắt buộc: lưu hàm lõi -> UI3 (staff/progress) -> trả hàm lõi -> guide chỉ hiển thị.
...
async function installCore(){
  ...
  if(!patched.includes('progressBar')||!patched.includes('water-final-core-pre.js')||!patched.includes('water-ui3.js')||!patched.includes('water-final-core-post.js')||!patched.includes('water-shot-guide.js')){
    throw new Error('Trang FINAL2 chưa tạo đúng');
  }
